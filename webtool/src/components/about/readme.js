...
- [$1 使用](#/about)
  - [$1.1 接口注释](#/about)
    - [$1.1.1 获得 **网页打印工具**宿主电脑上的打印机和纸张信息](#/about)
    - [$1.1.2 添加一个打印机配置](#/about)
    - [$1.1.3 获得打印机配置](#/about)
    - [$1.1.4 删除一个打印机配置](#/about)
    - [$1.1.5 更改一个打印机配置](#/about)
    - [$1.1.6 发一个打印命令](#/about)
    - [$1.1.7 获的打印过的页面](#/about)
    - [$1.1.8 设置远端websocket server url](#/about)
    - [$1.1.9 获得远端websocket 地址](#/about)
  - [$1.2 httpPost请求方式](#/about)
  - [$1.3 websocket 客户端方式](#/about)
  - [$1.4 websocket 服务端方式](#/about)
- [$2 作者和源码](#/about)
- [$3 另外。。。](#/about)
...
你建立一个websocket客户端，连接 **网页打印工具**提供的websocket 服务Url ws://127.0.0.1:8847, 建议使用这个方式，它无跨域的烦恼。
